...
if(isset($_POST['submit']))
{
    ...
    $sl;
        ...
        echo "<script>window.location.replace('http://bansachonline/product.php?id=$idsp'); </script>";
					...
					<div class="product">
						...
						<div class="col-md-6">
							<div class="caption">
								...
								<div class="well">
								<form name="form3" id="ff3" method="POST" action="product.php">
